...
public class C206_CaseStudy {
	...
	public static void main(String[] args) {
		...
		studentsList.add(new Students("Suhaify", "Republic Poly 765432", "P1", "P1-10", "Amran Mohamed", "Eddison", "21034014@myrp.edu.sg", 12345678));
		studentsList.add(new Students("Jia en", "Sesame Street 765432", "P2", "P2-11", "Amran Mohamed", "Qian Yi", "21034014@myrp.edu.sg", 12345678));

		ccaList.add(new CCA("Sports", "Soccer", "Kick ball", 10, 1, "Saturday", 15.00, 18.00, "Field", "Mr Amran"));
